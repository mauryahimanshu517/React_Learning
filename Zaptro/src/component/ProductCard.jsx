...
function ProductCard({ product }) {
    ...
    return (
        ...
        >
            ...
            <button onClick={() => addToCart(product)}  className="bg-red-500 px-3 py-2 text-sm rounded-md text-white w-full cursor-pointer flex gap-12 item-center justify-center font-semibold">Add to cart</button>
        </div>
